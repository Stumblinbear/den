...
// milliseconds, and which are refused with a fault. Called in process, since
// these read the number it returns.
import assert from "node:assert/strict";
import { test } from "node:test";
import { durationOr, type Section } from "../lib/config-table.mts";
import { Fault } from "../lib/shared/fault.mts";
...
test("a duration that is not one is a fault", () => {
