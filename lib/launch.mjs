...
/**
 * The entry is named relative to the plugin directory, which is the parent of
 * the directory this launcher sits in: what a plugin runs this way is not all
 * hooks. The interpreter is handed its own stdio so the entry talks to Claude
 * Code directly. The `--disable-warning` alias survives into Node 26, and
